...
All files are from `bb-aps12.zip`, distributed circa December 1998 on dextrose.com. Retrieved from the icequake.net mirror at
`http://n64.icequake.net/mirror/www.dextrose.com/files/n64/ips_tools/bb-aps12.zip` (which has an expired TLS certificate and may not be long for this world).
...
| File | Author | Notes |
|------|--------|-------|
| `snestl12.zip` | THE MCA (ELITE) | SNESTool v1.2, released February 12, 1996. Downloaded from [romhacking.net utility #18](https://www.romhacking.net/utilities/18). DOS tool. The tool's documentation credits "DAX and ME" (i.e. THE MCA) as inventors of the IPS format. |
...
table goes here. slap does not use this in any way it's just a curio
