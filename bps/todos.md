...
The implementation uses `crc32fast`, which is unambiguously CRC-32/ISO-HDLC — but the file names the library without recording *which CRC-32* that implies, or why the choice is final. Add a comment recording:
